class TasksController < ApplicationController
  ...
  private
    ...
    def task_params
      params.require(:task).permit(:title, :details, :creator_id, :assignee_id, :project_id, :completed_at, :difficulty, :duration, :due, :priority, :points, :assignment, :repository, assignments_attributes: [:id, :developer_id, :_destroy])
    end
end
